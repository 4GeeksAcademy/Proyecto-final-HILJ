        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="container text-center mt-3">
                ...
                <div className="row row-cols-3 row-cols-md-5 g-2">
                    ...
                    <div className="col">
                      <div className="card border-dark d-flex align-items-center justify-content-center" style={{ height: "30px", width: "90px" }}>
                        <div className="card-body d-flex align-items-center justify-content-center p-0">
                          <h6 className="card-title m-0">Tags</h6>
                        </div>
                      </div>
                    </div>
                </div>
            ...
            <div className="modal-footer d-flex justify-content-between">
              <button
                type="button"
                className="btn btn-clear-filter rounded-pill"
                data-bs-dismiss="modal"
              >
                Borrar Filtro
              </button>
              <button type="button" className="btn btn-apply-filter rounded-pill">
                Filtrar
              </button>
            </div>
          </div>
